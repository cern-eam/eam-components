...
function renderDefaultInput(inputProps) {
  ...
  return _react["default"].createElement(_EAMTextField["default"], {
    ...
    InputProps: _objectSpread({
      endAdornment: endAdornment && _react["default"].createElement(_InputAdornment["default"], {
...
function renderSuggestionContainer(suggestion, isHighlighted) {
  return _react["default"].createElement(_MenuItem["default"], {
    ...
    component: "div"
  }, _react["default"].createElement("div", null, _react["default"].createElement("div", null, suggestion.code, " - ", suggestion.desc)));
}
/**
...
function (_EAMBaseInput) {
  ...
  function EAMAutocomplete() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(EAMAutocomplete)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.state = {
      suggestions: []
    };
