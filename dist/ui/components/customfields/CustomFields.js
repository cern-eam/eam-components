...
function CustomFields(props) {
  ...
  var _useState3 = useState(),
    ...
    setCfs = _useState4[1];
  useEffect(function () {
    var loadCFList = function loadCFList() {
      var customfs;
      return _regeneratorRuntime().async(function loadCFList$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _regeneratorRuntime().awrap(WSCustomFields.getCustomFields(entityCode, classCode));
          case 3:
            customfs = _context.sent.body.data;
            setCfs(customfs);
            _context.next = 10;
            break;
          case 7:
