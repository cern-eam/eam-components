...
function (_Component) {
  ...
  function DocumentCreationOptions() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(DocumentCreationOptions)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.inputStyle = {
      flex: "1 1 auto",
...
var _default = DocumentCreationOptions;
