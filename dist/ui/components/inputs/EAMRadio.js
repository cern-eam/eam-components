...
var EAMRadio = function (_EAMBaseInput) {
    ...
    function EAMRadio() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EAMRadio.__proto__ || Object.getPrototypeOf(EAMRadio)).call.apply(_ref, [this].concat(args))), _this), _this.generateRadioButtons = function (values) {
            if (values) {
