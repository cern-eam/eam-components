...
var EAMPlusMinusInput = /*#__PURE__*/function (_React$Component) {
  ...
  function EAMPlusMinusInput() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(EAMPlusMinusInput)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.equipmentDivStyle = {
      width: "80%",
      display: "flex",
      alignItems: "center"
    };
  ...
  _createClass(EAMPlusMinusInput, [{
    ...
    value: function render() {
      ...
      }, _react["default"].createElement(_index.TRECIcon, {
        icon: "fa fa-plus",
...
var _default = EAMPlusMinusInput;
