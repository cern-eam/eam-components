...
function (_Component) {
  ...
  function ChecklistItemFollowUp() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ChecklistItemFollowUp)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.mainStyle = {
      flex: "1",
      display: "flex",
      marginLeft: 10
  ...
  _createClass(ChecklistItemFollowUp, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", {
        ...
        control: checklistItem.followUpWorkOrder ? _react["default"].createElement("div", {
          style: this.followUpWOCodeStyle
        }, _react["default"].createElement(_reactRouterDom.Link, {
          to: getWoLink(checklistItem.followUpWorkOrder),
          target: "_blank"
        }, checklistItem.followUpWorkOrder)) : _react["default"].createElement(_Checkbox["default"], {
          color: "primary",
