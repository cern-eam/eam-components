...
var Checklists = function Checklists(_ref) {
  ...
  var _useState9 = useState(getActivityCodeUrlParam()),
    ...
    filteredActivity = _useState0[0],
    setFilteredActivity = _useState0[1];
  var _useState1 = useState(null),
    _useState10 = _slicedToArray(_useState1, 2),
    filteredEquipment = _useState10[0],
    setFilteredEquipment = _useState10[1];
  var _useState11 = useState({}),
    _useState12 = _slicedToArray(_useState11, 2),
    checklistsHidden = _useState12[0],
    setChecklistsHidden = _useState12[1];
  var _useState13 = useState(parseToBoolean(getShowChecklistOptsUrlParam(), false)),
    _useState14 = _slicedToArray(_useState13, 2),
    showChecklistOptions = _useState14[0],
    setShowChecklistOptions = _useState14[1];
