...
var ChecklistItemInputChecklist =
/*#__PURE__*/
function (_Component) {
  ...
  function ChecklistItemInputChecklist() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ChecklistItemInputChecklist)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.mainStyle = {
      flex: "0 0 170px",
      display: "flex",
      marginLeft: 10
    ...
    _this.handleChange = function () {
      _this.props.onChange(_objectSpread({}, _this.props.checklistItem, {
        result: _this.props.checklistItem.result ? null : 'COMPLETED'
      }));
    };
