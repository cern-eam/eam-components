...
function (_Component) {
  ...
  function ChecklistItemInputFinding() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ChecklistItemInputFinding)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.mainStyle = {
      flex: "0 0 170px",
      display: "flex",
      marginLeft: 10,
    ...
    _this.handleChange = function (value) {
      ...
      var finding3 = checklistItem.possibleFindings[2];
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", {
        ...
        control: _react["default"].createElement(_Checkbox["default"], {
          ...
          onChange: function onChange() {
            return _this2.handleChange(finding3.code);
          }
        }),
        label: finding3.desc
      }));
