...
var ChecklistItemInputMoreFindings =
/*#__PURE__*/
function (_Component) {
  ...
  function ChecklistItemInputMoreFindings() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ChecklistItemInputMoreFindings)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.mainStyle = {
      flex: "0 0 170px",
      display: "flex",
      marginLeft: 10
