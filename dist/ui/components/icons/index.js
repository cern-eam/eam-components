...
exports.TRECLogo = exports.QuestionMarkCircleIcon = exports.NonRadioactiveWarningIcon = exports.ContaminationWarningIcon = exports.ChemicalWarningIcon = exports.FluidWarningIcon = exports.RadioactiveWarningIcon = exports.TRECIcon = exports.AssetIcon = exports.WorkorderIcon = exports.LocationIcon = exports.PositionIcon = exports.SystemIcon = exports.PartIcon = undefined;
...
var PartIcon = exports.PartIcon = function PartIcon(props) {
    return _react2.default.createElement(
        _SvgIcon2.default,
        _extends({}, props, { viewBox: '0 0 199 199' }),
...
var SystemIcon = exports.SystemIcon = function SystemIcon(props) {
    return _react2.default.createElement(
        _SvgIcon2.default,
        _extends({}, props, { viewBox: '0 0 100 100' }),
        _react2.default.createElement(
            'g',
            { stroke: 'null', id: 'svg_14' },
            _react2.default.createElement('path', { stroke: '#fff', id: 'svg_4',
            ...
            _react2.default.createElement('path', { stroke: '#fff', id: 'svg_5',
                ...
                strokeLinecap: 'null', strokeLinejoin: 'null', strokeWidth: '1.5' }),
            _react2.default.createElement('path', { stroke: '#fff', id: 'svg_7',
                ...
                strokeLinecap: 'null', strokeLinejoin: 'null', strokeWidth: '1.5' }),
            _react2.default.createElement('path', { stroke: '#fff', id: 'svg_8',
                ...
                strokeLinecap: 'null', strokeLinejoin: 'null', strokeWidth: '1.5' }),
            _react2.default.createElement('path', { stroke: '#000', id: 'svg_11', d: 'm20.833931,47.571093l60.986314,0l0,3.826183l-60.986314,0l0,-3.826183z',
                strokeLinecap: 'null', strokeLinejoin: 'null', strokeWidth: '1.5' }),
            _react2.default.createElement('path', { stroke: '#000', id: 'svg_13',
...
var TRECIcon = function TRECIcon(props) {
    ...
    switch (other.icon) {
        case 'vacuum-cleaner':
            {
                return _react2.default.createElement(
                    _SvgIcon2.default,
                    _extends({ className: className }, other, { viewBox: '0 0 485 585' }),
                    _react2.default.createElement(
                        'g',
                        null,
                        _react2.default.createElement('path', {
        ...
        case 'rwchecks':
            {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'g',
                        null,
                        _react2.default.createElement('polygon', { points: '424.562,363.906 172.036,363.906 65.893,121.304 0.001,121.304 0.001,90.978 85.737,90.978 191.876,333.584\r 424.562,333.584 \t\t\t' })
                    ),
                    _react2.default.createElement('path', { d: 'M272.934,439.727c0,25.109-20.381,45.485-45.49,45.485c-25.127,0-45.488-20.376-45.488-45.485\r c0-25.118,20.36-45.49,45.488-45.49C252.553,394.237,272.934,414.609,272.934,439.727z' }),
                    _react2.default.createElement('path', { d: 'M424.562,439.727c0,25.109-20.376,45.485-45.485,45.485c-25.118,0-45.49-20.376-45.49-45.485\r c0-25.118,20.372-45.49,45.49-45.49C404.187,394.237,424.562,414.609,424.562,439.727z' }),
                    _react2.default.createElement('path', { d: 'M379.077,242.606c-59.234,0-109.256-38.144-128.088-90.978h-99.36l60.654,151.629h212.279l35.008-87.482\r C436.944,232.42,409.255,242.606,379.077,242.606z' }),
                    _react2.default.createElement(
                        'g',
                        null,
                        _react2.default.createElement('path', { d: 'M379.077,0c-58.609,0-106.144,47.532-106.144,106.141c0,58.606,47.534,106.141,106.144,106.141\r c58.604,0,106.135-47.534,106.135-106.141C485.212,47.532,437.682,0,379.077,0z M362.995,159.742l-21.445-21.438l-32.161-32.163\r L330.834,84.7l32.161,32.161l64.326-64.321l21.436,21.44L362.995,159.742z' })
                    )
                );
            }
        ...
        default:
            {
                return _react2.default.createElement('i', _extends({ className: 'fa fa-question' }, other));
            }
    }
};

exports.TRECIcon = TRECIcon;
var RadioactiveWarningIcon = exports.RadioactiveWarningIcon = function RadioactiveWarningIcon(props) {
    return _react2.default.createElement(
        _SvgIcon2.default,
        _extends({}, props, { viewBox: '0 0 600 525' }),
        _react2.default.createElement('path', { d: 'M597.5,499.6L313.7,8c-2.9-5-8.2-8-13.9-8c-5.7,0-11,3.1-13.9,8L2.1,499.6c-2.9,5-2.9,11.1,0,16 c2.9,5,8.2,8,13.9,8h567.6c5.7,0,11-3.1,13.9-8C600.4,510.6,600.4,504.5,597.5,499.6z' }),
        _react2.default.createElement('polygon', { fill: '#e8bf28', points: '43.8,491.5 299.8,48.2 555.8,491.5' }),
        _react2.default.createElement('path', { d: 'M279.8,378.3L233,459.4c42.6,24.6,91.1,24.6,133.7,0l-46.8-81.1c-0.3,0.2-0.6,0.4-0.9,0.6 \tc-1.1,0.6-2.3,1.2-3.5,1.7c-1.2,0.5-2.4,1-3.7,1.4c-1.3,0.4-2.5,0.7-3.8,1c-1.3,0.3-2.6,0.5-4,0.6c-1.3,0.1-2.7,0.2-4.1,0.2 c-1.4,0-2.7-0.1-4.1-0.2c-1.3-0.1-2.7-0.3-4-0.6c-1.3-0.3-2.6-0.6-3.8-1c-1.3-0.4-2.5-0.8-3.7-1.4c-1.2-0.5-2.4-1.1-3.5-1.7 C280.4,378.7,280.1,378.5,279.8,378.3z' }),
        _react2.default.createElement('path', { d: 'M233,227.8c-42.6,24.6-66.8,66.6-66.8,115.8h93.6c0-1.4,0.1-2.8,0.2-4.1c0.1-1.3,0.4-2.7,0.6-4 \tc0.3-1.3,0.6-2.6,1-3.8c0.4-1.3,0.8-2.5,1.4-3.7c0.5-1.2,1.1-2.4,1.7-3.5c0.6-1.1,1.3-2.2,2-3.3c0.7-1.1,1.5-2.1,2.3-3.1 \tc0.8-1,1.7-1.9,2.6-2.8c0.9-0.9,1.9-1.8,2.9-2.6c1-0.8,2-1.6,3.1-2.3c0.8-0.5,1.6-1,2.4-1.5L233,227.8z' }),
        _react2.default.createElement('path', { d: 'M366.7,227.8l-46.8,81.1c0.8,0.5,1.6,0.9,2.4,1.5c1.1,0.7,2.1,1.5,3.1,2.3c1,0.8,1.9,1.7,2.9,2.6 \tc0.9,0.9,1.8,1.9,2.6,2.8c0.8,1,1.6,2,2.3,3.1c0.7,1.1,1.4,2.2,2,3.3c0.6,1.1,1.2,2.3,1.7,3.5c0.5,1.2,1,2.4,1.4,3.7 c0.4,1.3,0.7,2.5,1,3.8s0.5,2.6,0.6,4c0.1,1.3,0.2,2.7,0.2,4.1h93.6C433.5,294.4,409.3,252.4,366.7,227.8z' }),
        _react2.default.createElement('circle', { cx: '299.8', cy: '343.6', r: '26.7' })
    );
};

var FluidWarningIcon = function FluidWarningIcon(_ref) {
    var _ref$color = _ref.color,
        color = _ref$color === undefined ? "#81D4FA" : _ref$color,
        otherProps = _objectWithoutProperties(_ref, ['color']);

    return _react2.default.createElement(
        _SvgIcon2.default,
        _extends({}, otherProps, { viewBox: '0 0 31 27' }),
        _react2.default.createElement(
            'g',
            null,
            _react2.default.createElement('path', { id: 'svg_4', d: 'm30.028882,24.714101l-14.014815,-24.276544c-0.14321,-0.246914 -0.404938,-0.395062 -0.68642,-0.395062c-0.281481,0 -0.54321,0.153086 -0.68642,0.395062l-14.014815,24.276544c-0.14321,0.246914 -0.14321,0.548148 0,0.790123c0.14321,0.246914 0.404938,0.395062 0.68642,0.395062l28.02963,0c0.281481,0 0.54321,-0.153086 0.68642,-0.395062c0.14321,-0.246914 0.14321,-0.548148 0,-0.790123z' }),
            _react2.default.createElement('polygon', { id: 'svg_5', points: '2.6856727600097656,24.684456825256348 15.327640533447266,2.7930994033813477 27.969608306884766,24.684456825256348 ',
                fill: color }),
            _react2.default.createElement(
                'text',
                { fontWeight: 'bold', stroke: 'null', transform: 'matrix(0.7553763564635644,0,0,0.722125470638275,3.383501128953198,5.721176045946776) ',
...
exports.FluidWarningIcon = FluidWarningIcon;
var ChemicalWarningIcon = function ChemicalWarningIcon(_ref2) {
    var _ref2$color = _ref2.color,
        color = _ref2$color === undefined ? "#FB8C00" : _ref2$color,
...
exports.ChemicalWarningIcon = ChemicalWarningIcon;
var ContaminationWarningIcon = function ContaminationWarningIcon(_ref3) {
    var _ref3$color = _ref3.color,
        color = _ref3$color === undefined ? "#FFF176" : _ref3$color,
        otherProps = _objectWithoutProperties(_ref3, ['color']);
...
exports.ContaminationWarningIcon = ContaminationWarningIcon;
var NonRadioactiveWarningIcon = exports.NonRadioactiveWarningIcon = function NonRadioactiveWarningIcon(props) {
    return _react2.default.createElement(_CheckCircle2.default, { style: { color: _green2.default['A700'] } });
};

var QuestionMarkCircleIcon = exports.QuestionMarkCircleIcon = function QuestionMarkCircleIcon(props) {
    return _react2.default.createElement(_mdiMaterialUi.HelpCircle, null);
};

var TRECLogo = function TRECLogo(_ref4) {
    var _ref4$size = _ref4.size,
        size = _ref4$size === undefined ? "20" : _ref4$size,
        _ref4$color = _ref4.color,
        color = _ref4$color === undefined ? "#2196F3" : _ref4$color,
        _ref4$fontSize = _ref4.fontSize,
        fontSize = _ref4$fontSize === undefined ? "20px" : _ref4$fontSize,
        _ref4$fontWeight = _ref4.fontWeight,
        fontWeight = _ref4$fontWeight === undefined ? "900" : _ref4$fontWeight,
        otherProps = _objectWithoutProperties(_ref4, ['size', 'color', 'fontSize', 'fontWeight']);
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            _SvgIcon2.default,
            _extends({}, otherProps, { viewBox: '0 0 310 310', style: { width: size + "px", height: size + "px" } }),
            _react2.default.createElement(
                'g',
                null,
                _react2.default.createElement('path', { d: 'M155,0C69.533,0,0,69.533,0,155s69.533,155,155,155s155-69.533,155-155S240.467,0,155,0z M216.348,270.173l-41.33-76.279   c-6.004,3.103-12.807,4.867-20.018,4.867s-14.014-1.764-20.018-4.867l-41.33,76.279c-41.064-21.961-69.086-65.238-69.17-114.951   l86.789-0.155c-0.012-0.456-0.033-0.91-0.033-1.368c0-15.325,7.926-27.525,19.885-35.345l-44.889-74.24   C106.217,31.678,129.781,24.481,155,24.481c25.217,0,48.779,7.196,68.76,19.631l-44.875,74.25   c11.955,7.82,19.877,19.969,19.877,35.29c0,0.458-0.021,0.912-0.035,1.368l86.789,0.203   C285.432,204.935,257.412,248.212,216.348,270.173z', fill: color }),
                _react2.default.createElement('circle', { cx: '155', cy: '155', r: '28.052', fill: color })
            )
        ),
        _react2.default.createElement(
            'div',
