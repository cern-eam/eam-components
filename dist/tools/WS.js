...
var WS = /*#__PURE__*/function () {
  ...
  return _createClass(WS, [{
    ...
    key: "getGridDataNative",
    value: function getGridDataNative(gridRequest) {
      var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    ...
    value: function getGridData(gridRequest) {
      var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      return this.getGridDataNative(gridRequest, config).then(transformNativeResponse)["catch"](function (error) {
