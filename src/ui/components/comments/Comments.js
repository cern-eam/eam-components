...
class Comments extends Component {
  ...
  componentDidUpdate(prevProps) {
    //Just read for existing object
    if (
      (prevProps.entityKeyCode !== this.props.entityKeyCode ||
        prevProps.entityCode !== this.props.entityCode) &&
  ...
  updateComment = (comment) => {
    const canUpdate =
      ...
      (this.props.currentUsrCode &&
        this.props.currentUsrCode === comment.creationUserCode);
    if (canUpdate) {
      //Remove pk property
      delete comment.pk;
