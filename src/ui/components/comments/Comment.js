...
class Comment extends Component {
  ...
  render() {
    const { allowHtml, restrictEditToCreator, currentUsrCode } = this.props;
    ...
    const cannotEdit =
      restrictEditToCreator &&
      currentUsrCode &&
      currentUsrCode !== comment?.creationUserCode;
        ...
        <div className="commentContainer" style={this.state.containerStyle}>
          ...
          <div className="commentInfoContainer">
            ...
            >
              ...
              {this.props.comment.typeCode === "+" && (
                <FlagCheckered color="primary" />
              )}
            </div>
          </div>
          ...
          {this.props.commentFooter && (
            <div className="commentFooter">{this.props.commentFooter}</div>
          )}
        </div>
      </ListItem>
    );
